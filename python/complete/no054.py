...
if __name__ == "__main__":
    print "The answer to Euler Project, question 54 is:",
    with open('/Users/dan/Documents/sandbox/'
              'euler_project/problem_data/no054.txt', 'r') as fh:
        hands = [ read_hand(row) for row in fh.read().split("\n") if row ]
